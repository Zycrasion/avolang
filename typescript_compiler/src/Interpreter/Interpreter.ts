...
export function FindFunctionWithinScope(scope : Scope, FunctionName : string) : AvoFunction | undefined
{
...
export function FindVariableWithinScope(scope : Scope, VariableName : string) : AvoVariable | undefined
{
